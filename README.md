...
This is project for Udacity's Front-End Developer nanadegree program where I had to implement functionality for a shopping cart, add to cart, remove from cart, increase/decrease quanity and display quanity and the price for each product. I also had to implement functionaility for check out feature, show the total of price of all products, enter a amount being paid, and return the balance owed, or change owed. I was given stater code and images. The only file I created was the 'script.js' 

## Installation

git clone https://github.com/NGibson1/-Shopping-Cart-Functionality-Udacity-Project.git
cd shopping-Cart-Functionality-Udacity-Project

# Shopping Cart Functionality  Udacity Project
